...
<!DOCTYPE html>
	<head>
		...
		<title>Прописи|Авторизация</title>
...
?>
		...
		<div class="succes_m">
		<p class="success_message">Регистрация прошла успешно!</p>
		<p class="success_message">Теперь Вы можете авторизоваться используя Ваш логин и пароль.</p>
		</div>
